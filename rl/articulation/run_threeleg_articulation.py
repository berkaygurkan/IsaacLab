...
from omni.isaac.lab_assets.unitree import UNITREE_A1_THREELEG_CFG  # isort: skip
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # Articulation
    unitreeA1_cfg = UNITREE_A1_THREELEG_CFG.copy()
    unitreeA1_cfg.prim_path = "/World/Origin.*/Robot"
    unitreeA1 = Articulation(cfg=unitreeA1_cfg)

    print(unitreeA1_cfg.init_state.joint_pos)
...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    count = 0
    # Simulation loop
    print("[INFO] Joint Positions",robot.data.joint_pos)
